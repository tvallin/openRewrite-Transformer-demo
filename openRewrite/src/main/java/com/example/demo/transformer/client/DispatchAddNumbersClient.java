...
package com.example.demo.transformer.client;
...
public class DispatchAddNumbersClient {
    ...
    private static String endpointAddress = "http://localhost:8080/jaxws-restful/addnumbers";
    ...
    private static void printSource(Source source) {
        try {
            ...
            System.out.println("**** Response ******" + bos);
            System.out.println("");
            bos.close();
        } catch (Exception e) {
            e.printStackTrace();
